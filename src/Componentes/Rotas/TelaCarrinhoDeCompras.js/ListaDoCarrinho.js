...
function createData(name, calories, fat, carbs, protein,outros) {
  return {
    name,
    calories,
    fat,
...
var rows = [
  createData('teste', 452, 25.0, 51, 4.9),
  ...
  createData('testando', 518, 26.0, 65, 7.0),
...
export default function ListaDoCarrinho({list}) {
